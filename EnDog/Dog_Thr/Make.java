...
/*
                                if(select.equals("5")){
                                println(name+" "+ dog.dogMove("f"));
				}else{
                                println(name+" "+dog.dogMove("t"));
                                }
                         println(name+" "+dog.walk());
                         println(name+" "+dog.eat());
                         println(name+" "+dog.sit());
                         println(name+" "+dog.bark());
                                if(select.equals("1") || select.equals("3")){
                                println(name+" "+dog.dogPower("f"));
                                }else if(select.equals("2") || select.equals("4")){
                                println(name+" "+dog.dogPower("i"));
                                }else{
                                println(name+" "+dog.dogPower("n"));
                                }
